...
# Timestamp: 2020/06/04 19:23:30 UTC
# 
...
RUN echo '{ \
    ...
    \n      [ \
    \n        ".", \
    \n        "C:/Program Files/Git/home/coder/project" \
    \n      ] \
    \n    ], \
    \n    [ \
    \n      "user", \
    ...
    \n    [ \
    \n      "workdir", \
    \n      "C:/Program Files/Git/home/coder" \
    \n    ], \
    \n    [ \
    \n      "env", \
    \n      { \
    ...
    \n    [ \
    \n      "run", \
    \n      "conda init && . /home/coder/.bashrc && . activate neuro && pip install -e /home/coder/project/" \
    \n    ], \
    \n    [ \
    \n      "entrypoint", \
    \n      "xnat_downloader" \
